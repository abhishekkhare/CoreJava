...
/**
 * Arrays, linked lists, trees, etc. are best for data that represents real objects. Stacks & Queues are instead used to complete a task and are soon after discarded.
 * 
 * Stacks & Queues
 * 
