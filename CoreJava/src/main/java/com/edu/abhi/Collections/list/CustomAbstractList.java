 ...
 * class and provide implementations for the get(int) and size() methods. To
 * implement a modifiable list, the programmer must additionally override the
 ...
 * specification. Unlike the other abstract collection implementations, the
 * programmer does not have to provide an iterator implementation; the iterator
 * and list iterator are implemented by this class, on top of the
 * "random access" methods: get(int), set(int, E), add(int, E) and remove(int).
 * 
 * The documentation for each non-abstract method in this class describes its
 * implementation in detail. Each of these methods may be overridden if the
 * collection being implemented admits a more efficient implementation. This
...
public abstract class CustomAbstractList<E> extends CustomAbstractCollection<E>
    ...
    public int indexOf(Object o) {
        CustomListIterator<E> e = listIterator();
        if (o==null) {
            while (e.hasNext())
                if (e.next()==null)
    ...
    public int lastIndexOf(Object o) {
        CustomListIterator<E> e = listIterator(size());
        if (o==null) {
            while (e.hasPrevious())
                if (e.previous()==null)
                    return e.nextIndex();
    ...
    private class CustomListItr extends Itr implements CustomListIterator<E> {
    ...
    public CustomList<E> subList(int fromIndex, int toIndex) {
        return (this instanceof RandomAccess ?
                new CustomRandomAccessSubList<E>(this, fromIndex, toIndex) :
                new CustomSubList<E>(this, fromIndex, toIndex));
    }
    ...
    public boolean equals(Object o) {
        ...
        CustomListIterator<E> e1 = listIterator();
        CustomListIterator<?> e2 = ((CustomList<?>) o).listIterator();
    ...
    protected void removeRange(int fromIndex, int toIndex) {
        CustomListIterator<E> it = listIterator(fromIndex);
...
class CustomSubList<E> extends CustomAbstractList<E> {
    ...
    public CustomListIterator<E> listIterator(final int index) {
        ...
        return new CustomListIterator<E>() {
            private final CustomListIterator<E> i = l.listIterator(index+offset);
    ...
    public CustomList<E> subList(int fromIndex, int toIndex) {
        return new CustomSubList<E>(this, fromIndex, toIndex);
    }
...
class CustomRandomAccessSubList<E> extends CustomSubList<E> implements RandomAccess {
	CustomRandomAccessSubList(CustomAbstractList<E> list, int fromIndex, int toIndex) {
        super(list, fromIndex, toIndex);
    }

    public CustomList<E> subList(int fromIndex, int toIndex) {
        return new CustomRandomAccessSubList<E>(this, fromIndex, toIndex);
    }}
