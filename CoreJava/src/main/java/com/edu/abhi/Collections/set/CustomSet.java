 ...
 *         contain any additional stipulations.) The additional stipulation on
 *         constructors is, not surprisingly, that all constructors must create
 *         a set that contains no duplicate elements (as defined above).
 * 
 ...
 * @param <E>
 */
public interface CustomSet<E> extends CustomCollection<E>,Set<E> {
